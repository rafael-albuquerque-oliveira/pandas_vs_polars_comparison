...
* **Execution Time:** Polars processed the dataset in **[XX.X]s**, compared to **[XX.X]s** with Pandas.
* **Memory Consumption (Peak RAM):** Polars used only **[XXX]MB**, while Pandas required **[XXX]MB** of system memory.
